// src/lib.rs
/*
 * Core library for GeminiGateway
 */
...
#[derive(Debug)]
pub struct GeminiGatewayProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GeminiGatewayProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GeminiGateway processing");
    
    let mut processor = GeminiGatewayProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GeminiGatewayProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GeminiGatewayProcessor::new(false);
